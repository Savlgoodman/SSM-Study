...
public class UserInfoController {
    ...
    public Result<IPage<UserInfo>> pageUserInfo(@RequestParam long current, @RequestParam long size, UserInfoQueryVo queryVo) {
        ...
        userInfoWrapper.like(queryVo.getPhone() != null,UserInfo::getPhone,queryVo.getPhone());
        userInfoWrapper.eq(queryVo.getStatus() != null,UserInfo::getStatus,queryVo.getStatus());
        IPage<UserInfo> res = userInfoService.page(page, userInfoWrapper);
